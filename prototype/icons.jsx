...
// Kept inline + minimal so we don't pull a library.

const Icon = ({ d, size = 18, fill = false, stroke = 1.5, children, style }) => (
  <svg
...
const Icons = {
  ...
  Slideshow: (p) => <Icon {...p}><rect x="3" y="4" width="18" height="13" rx="2"/><path d="M10 9.5 14 12 10 14.5z" fill="currentColor" stroke="none"/><path d="M8 20h8"/></Icon>,
  TV:       (p) => <Icon {...p}><rect x="3" y="4" width="18" height="13" rx="2"/><path d="M8 20h8"/></Icon>,
  Query:    (p) => <Icon {...p}><ellipse cx="12" cy="5" rx="8" ry="3"/><path d="M4 5v6c0 1.7 3.6 3 8 3s8-1.3 8-3V5"/><path d="M4 11v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6"/></Icon>,
  Plug:     (p) => <Icon {...p}><path d="M9 2v6M15 2v6M7 8h10v4a5 5 0 0 1-5 5h0a5 5 0 0 1-5-5V8zM12 17v5"/></Icon>,
  ...
  Refresh:  (p) => <Icon {...p}><path d="M3 12a9 9 0 0 1 15.6-6.1L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-15.6 6.1L3 16"/><path d="M3 21v-5h5"/></Icon>,
  ...
  Play:     (p) => <Icon {...p}><path d="M6 4 20 12 6 20z" fill="currentColor" stroke="none"/></Icon>,
  ...
  Youtube:  (p) => <Icon {...p}><rect x="2" y="5" width="20" height="14" rx="3"/><path d="m10 9 5 3-5 3z" fill="currentColor" stroke="none"/></Icon>,
  ...
  Wifi:     (p) => <Icon {...p}><path d="M5 12a10 10 0 0 1 14 0M2 8.5a15 15 0 0 1 20 0M8.5 15.5a5 5 0 0 1 7 0"/><circle cx="12" cy="19" r="1" fill="currentColor"/></Icon>,
